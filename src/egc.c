...
int32_t
computeUnitaryFractions(int64_t num, int64_t den, int64_t *s) {
    int64_t n, i;
...
void
promptForParameter(char *str, int64_t *n) {
    printf("%s", str);
    scanf(" %ld", n);
}

void
csvOutput(int64_t *s, int64_t n) {
    int64_t i;
...
void
simpleOutput(int64_t *s, int64_t n) {
    int64_t i;
...
void
straightOutput(int64_t *s, int64_t n) {
    int64_t i;
